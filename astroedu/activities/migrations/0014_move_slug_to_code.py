...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for a in orm.Activity.objects.all():
            a.code = a.slug
            if a.code == '0000':
                a.title = 'Test Activity - Levitating Astronaut'
            a.slug = slugify(a.title)
            a.save()

            r = Redirect()
            r.site = current_site
            r.old_path = '/activities/' + a.code + '/'
            r.new_path = '/activities/' + a.slug + '/'
            r.save()
    ...
    def backwards(self, orm):
        for a in orm.Activity.objects.all():
            ...
            r = Redirect.objects.get(site=current_site, old_path='/activities/' + a.code + '/')
            r.delete()
