...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Institution.url'
        db.alter_column(u'activities_institution', 'url', self.gf('django.db.models.fields.URLField')(max_length=255))
        # Adding unique constraint on 'Institution', fields ['slug']
        db.create_unique(u'activities_institution', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Institution', fields ['slug']
        db.delete_unique(u'activities_institution', ['slug'])


        # Changing field 'Institution.url'
        db.alter_column(u'activities_institution', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))
