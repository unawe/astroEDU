...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RepositoryEntry'
        db.create_table(u'activities_repositoryentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('repo', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Activity'])),
        ))
        db.send_create_signal(u'activities', ['RepositoryEntry'])


    def backwards(self, orm):
        # Deleting model 'RepositoryEntry'
        db.delete_table(u'activities_repositoryentry')
