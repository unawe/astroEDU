...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.acknowledgement'
        db.add_column(u'activities_activity', 'acknowledgement',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.acknowledgement'
        db.delete_column(u'activities_activity', 'acknowledgement')


    models = {
        u'activities.activity': {
            'Meta': {'ordering': "['-slug']", 'object_name': 'Activity'},
            'acknowledgement': ('django.db.models.fields.TextField', [], {'max_length': '255', 'blank': 'True'}),
