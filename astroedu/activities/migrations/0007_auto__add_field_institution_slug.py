...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.slug'
        db.add_column(u'activities_institution', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=None, max_length=50, db_index=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Institution.slug'
        db.delete_column(u'activities_institution', 'slug')
    ...
    models = {
        ...
        u'activities.institution': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'False'})
        },
