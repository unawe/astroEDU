...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.citable_name'
        db.add_column(u'activities_author', 'citable_name',
                      self.gf('django.db.models.fields.CharField')(default='.', max_length=255),
                      keep_default=False)

        # Adding field 'Activity.doi'
        db.add_column(u'activities_activity', 'doi',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.citable_name'
        db.delete_column(u'activities_author', 'citable_name')

        # Deleting field 'Activity.doi'
        db.delete_column(u'activities_activity', 'doi')
