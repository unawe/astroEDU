...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'activities_activity', 'code',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=4, blank=True),
                      keep_default=False)


        # Changing field 'Activity.slug'
        db.alter_column(u'activities_activity', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255))

        # Changing field 'Activity.acknowledgement'
        db.alter_column(u'activities_activity', 'acknowledgement', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Activity.slug'
        db.alter_column(u'activities_activity', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'Activity.acknowledgement'
        db.alter_column(u'activities_activity', 'acknowledgement', self.gf('django.db.models.fields.TextField')(max_length=255))
    ...
    models = {
        u'activities.activity': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '4', 'blank': 'True'}),
