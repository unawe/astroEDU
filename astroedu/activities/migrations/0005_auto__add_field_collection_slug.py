...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'activities_collection', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=str(uuid.uuid4()), unique=True, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.slug'
        db.delete_column(u'activities_collection', 'slug')
