...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'activities_collection', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Collection.published'
        db.add_column(u'activities_collection', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Collection.release_date'
        db.add_column(u'activities_collection', 'release_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None),
                      keep_default=False)

        # Adding field 'Collection.embargo_date'
        db.add_column(u'activities_collection', 'embargo_date',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'activities_collection', 'featured')

        # Deleting field 'Collection.published'
        db.delete_column(u'activities_collection', 'published')

        # Deleting field 'Collection.release_date'
        db.delete_column(u'activities_collection', 'release_date')

        # Deleting field 'Collection.embargo_date'
        db.delete_column(u'activities_collection', 'embargo_date')
